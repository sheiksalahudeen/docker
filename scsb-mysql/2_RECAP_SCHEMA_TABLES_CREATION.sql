...
INDEX `OCLC_idx` (`OCLC` ASC),
INDEX `ISBN_idx` (`ISBN` ASC),
INDEX `ISSN_idx` (`ISSN` ASC),
...
CREATE TABLE IF NOT EXISTS `USERS_T` (
  ...
  `USER_INSTITUTION` VARCHAR(15) NULL,
  `USER_DESCRIPTION` VARCHAR(45) NULL,
  PRIMARY KEY (`USER_ID`),
  UNIQUE INDEX `LOGIN_ID_UNIQUE` (`LOGIN_ID` ASC, `USER_INSTITUTION` ASC))
