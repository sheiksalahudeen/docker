...
ALTER TABLE `BIBLIOGRAPHIC_T` ADD COLUMN `BIBHOLDING_LAST_UPDATED_DATE` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE `BIBLIOGRAPHIC_T` ADD COLUMN `BIBITEM_LAST_UPDATED_DATE` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;

UPDATE `BIBLIOGRAPHIC_T` SET `BIBHOLDING_LAST_UPDATED_DATE`=`LAST_UPDATED_DATE`;

UPDATE `BIBLIOGRAPHIC_T` SET `BIBITEM_LAST_UPDATED_DATE`=`LAST_UPDATED_DATE`;
