...
ALTER TABLE `BIBLIOGRAPHIC_T` ADD COLUMN `BIBHOLDING_LAST_UPDATED_DATE` DATETIME NOT NULL;

ALTER TABLE `BIBLIOGRAPHIC_T` ADD COLUMN `BIBITEM_LAST_UPDATED_DATE` DATETIME NOT NULL;
